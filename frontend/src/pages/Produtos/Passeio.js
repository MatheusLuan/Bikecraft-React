...
import bikcraft_passeio_2 from '../../assets/produtos/bikcraft-passeio-2.jpg';

import passeio from '../../assets/produtos/passeio.svg';

import './style.css';

export default function Produtos_passeio() {
    return (
        <div>
            <Cpn_Header />
            ...
            <section className="container produto_item fadeInDown" data-anime="1200">
                ...
                <div className="grid-8"><img src={bikcraft_passeio_2} alt="Bikcraft Passeio" /></div>
            ...
            <section className="orcamento">
                <div className="container">
                    ...
                    <form id="form_orcamento" method="POST"  className="form grid-8 formphp">
