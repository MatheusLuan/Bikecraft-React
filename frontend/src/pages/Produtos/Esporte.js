...
import bikcraft_esporte_2 from '../../assets/produtos/bikcraft-esporte-2.jpg';
...
export default function Produtos_esporte() {
    return (
        <div>
            <Cpn_Header />
            ...
            <section className="container produto_item">
                ...
                <div className="grid-8"><img src={bikcraft_esporte_2} alt="Bikcraft Esporte" /></div>
